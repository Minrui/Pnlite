...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
	<center>
		<form action="/send_post.php" enctype="multipart/form-data" method="post" onsubmit="return hasCheckAny();">
            <table style="width:400px">
                <tr><th scope="col" colspan="2" align="center" >教师文件发送</th></tr>
				<?php
				...
				?>				
				<tr class="even"><td><input type="checkbox" id="checkall_stu" onclick="CheckAllCus();"/>全选</td><td>学生状态(<?=$stu_count?>/<?=$stu_total?>)</td></tr>
				<?=$stu_html?>
				...
				<tr class="<?=$tr_class[1-$tr_seq]?>">
					...
					<input type="button" class="btn" value="添加附件" onclick="createMyFile();" />
					<table><tbody id="filetable"><tr id="myfile_0"><td><input type="file" name="myfile[]" /></td><td><input class="btn" type="button" onclick="$('myfile_0').parentNode.removeChild($('myfile_0'));" value="删除" /></td></tr></tbody></table>
